...
# def display_color_image_with_detection(color_component, name="ColorCameraImage"):
...
#                         display_color_image_with_detection(texture_rgb_component)  # Display with YOLO detection
...
#             # Exit infinite loop if 'q' is pressed
#             if cv2.waitKey(1) == ord('q'):
